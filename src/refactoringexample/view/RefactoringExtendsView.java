...
public class RefactoringExtendsView extends ViewPart{
...
//		tableviewer.setInput(InstanceofAnalysis.refactoringextends);
		tableviewer.setInput(AnnotationRefactoring.refactoringextends);
